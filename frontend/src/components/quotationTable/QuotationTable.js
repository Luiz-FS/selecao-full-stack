...
import { Hidden, Paper, styled, Table, TableBody, TableCell, tableCellClasses, TableContainer, TableHead, TablePagination, TableRow } from "@mui/material";
                ...
                <Table className="quotation-table-container" aria-label="customized table">
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell align="left">Mínima</StyledTableCell>
                            <StyledTableCell align="left">Máxima</StyledTableCell>
                    ...
                    {rows.map((row, i) => (
                        ...
                        <Hidden smUp>
                            <StyledTableCell align="left">{formatDate(row.create_date)}</StyledTableCell>
                        </Hidden>
                        <StyledTableCell align="left">{row.min_price}</StyledTableCell>
                        <StyledTableCell align="left">{row.max_price}</StyledTableCell>
