...
COIN_TO_BACKEND_API = {
    ...
    "BTC / EUR": KrakenQuoteRefresh(name="BTC / EUR", key="XBTeur", data_key="XXBTZEUR", awesomeapi_coin_key="BTC-EUR"),
    "BTC / USD": KrakenQuoteRefresh(name="BTC / USD", key="XBTusd", data_key="XXBTZUSD", awesomeapi_coin_key="BTC-USD"),
}