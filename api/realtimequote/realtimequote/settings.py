...
AUTHENTICATOR_URI = config("AUTHENTICATOR_URI", default="http://localhost:8001", cast=str)
...
LOCAL_APPS = ["apps.coin.apps.CoinConfig", "apps.quotation.apps.QuotationConfig"]
